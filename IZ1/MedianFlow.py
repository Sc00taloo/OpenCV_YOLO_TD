import cv2
import time
from Summary_table import recovery_rate_median, lost_percentage_median, total_time_median

def medianflow_trac(video_path):
    # Открываем видео
    ...
    if bbox[2] > 0 and bbox[3] > 0:
        ...
        result_video_path = f"MedianFlow_{video_path}"
